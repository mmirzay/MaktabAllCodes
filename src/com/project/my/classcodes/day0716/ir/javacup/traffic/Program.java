...
import com.project.my.classcodes.day0716.ir.javacup.traffic.impl.TrafficInfo;
import com.project.my.classcodes.day0716.ir.javacup.traffic.impl.TrafficInfoTransformer;
import com.project.my.classcodes.day0716.ir.javacup.traffic.impl.TrafficObservable;
...
public class Program {
	...
	public static void main(String[] args) {
		...
		new Context<TrafficInfo, String>().observable(observable).transformer(transformer).subscriber(subscriber1)
				.subscriber(subscriber2).run(inputs);
	}
